...
const [components, setComponents] = useState(<BuyerProduct/>); 
    ...
    return(
        <>
            ...
            <div class="col-3" style={{width:"20vw" ,backgroundColor:"grey"}}>
               
                
                    <button class=" btn btn-outline-primary me-2" type="button" style={{width:"30vh" , marginTop:"10vh"}} onClick={showProduct} >View Products</button>
                    <button class=" btn btn-outline-primary me-2" type="button" style={{width:"30vh" ,marginTop:"10vh"}} onClick={showCart}>My Cart</button>
                    <button class=" btn btn-outline-primary me-2" type="button" style={{width:"30vh" , marginTop:"10vh"}} onClick={handleProfile} >Update Profile</button>
