...
function BuyerProduct(){
    ...
    return(
        <div>
                ...
                <div >
                    <button type="button" className="btn btn-success" onClick={handleSearchAll}>All</button>
                </div>
                  ...
                  <div className="row">
                    <div className="col-12 " >
                      <form class="d-flex mt-3">
                        ...
                        <button class="btn btn-outline-primary" type="submit" onClick={handleSearch}>Search</button>
                      </form>
                    </div>
                  </div>
                </div>
